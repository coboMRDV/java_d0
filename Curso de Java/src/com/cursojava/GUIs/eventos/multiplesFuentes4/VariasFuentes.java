package com.cursojava.GUIs.eventos.multiplesFuentes4;
...
class Panel extends JPanel {
	...
	public Panel() {
		...
		/** ROJO **/
		KeyStroke redShortCut = KeyStroke.getKeyStroke("ctrl R");
		...
		/** VERDE **/
		KeyStroke shortCutVerde = KeyStroke.getKeyStroke("ctrl V");
